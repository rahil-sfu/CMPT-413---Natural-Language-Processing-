...
if __name__ == '__main__':
    ...
    #optparser.add_option("-f", "--retrofitwordvecfile", dest="rfwordvecfile", default=os.path.join('data', 'glove.6B.100d.retrofit.magnitude'), help="retrofitted word vectors file")
    ...
    #rflexsub = LexSub(opts.rfwordvecfile, int(opts.topn))
